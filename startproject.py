...
def startProject(name, language, flag_var):
    ...
    # Convert the flag_var to a list of strings where each element is a flag
    flags = os.environ(flag_var).split()
